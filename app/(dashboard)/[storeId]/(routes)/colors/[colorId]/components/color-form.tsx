...
const formSchema = z.object({
    ...
    value: z.string().min(1).regex(/^#/, {
        message: 'La cadena de texto debe ser un código HEX'
    })
})
...
export const ColorForm: React.FC<ColorFormProps> = ({
    ...
    const title = initialData ? "Editar color" : "Crear un nuevo color"
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <div className="flex items-center gap-x-4">
                                            <Input disabled={loading} placeholder="Código color" {...field}/>
                                            <div 
